...
export const dict: Record<I18nKey, string> = {
  ...
  "sessions.sidebar.session.status.working": "Працює",
  "sessions.sidebar.session.status.waiting": "Очікує",
  "sessions.sidebar.session.status.done": "Готово",
  "sessions.sidebar.session.status.settle": "Завершити",
  ...
  "chat.chatInput.switchBranch": "Перемкнути",
