...
export const dict = {
  ...
  'sessions.sidebar.session.status.working': 'Working',
  'sessions.sidebar.session.status.waiting': 'Waiting',
  'sessions.sidebar.session.status.done': 'Done',
  'sessions.sidebar.session.status.settle': 'Settle',
