...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.session.status.working': '工作中',
  'sessions.sidebar.session.status.waiting': '等待中',
  'sessions.sidebar.session.status.done': '已完成',
  'sessions.sidebar.session.status.settle': '确认',
