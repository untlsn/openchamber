...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.session.status.working': '작업 중',
  'sessions.sidebar.session.status.waiting': '대기 중',
  'sessions.sidebar.session.status.done': '완료',
  'sessions.sidebar.session.status.settle': '확정',
