...
export const dict: Record<I18nKey, string> = {
  ...
  'sessions.sidebar.session.status.working': 'Pracuje',
  'sessions.sidebar.session.status.waiting': 'Oczekuje',
  'sessions.sidebar.session.status.done': 'Gotowe',
  'sessions.sidebar.session.status.settle': 'Zatwierdź',
  ...
  'chat.chatInput.switchBranch': 'Przełącz',
