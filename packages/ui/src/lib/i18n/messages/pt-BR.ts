...
export const dict: Record<I18nKey, string> = {
  ...
  "sessions.sidebar.session.status.working": "Trabalhando",
  "sessions.sidebar.session.status.waiting": "Aguardando",
  "sessions.sidebar.session.status.done": "Concluído",
  "sessions.sidebar.session.status.settle": "Finalizar",
  ...
  "chat.chatInput.switchBranch": "Trocar",
